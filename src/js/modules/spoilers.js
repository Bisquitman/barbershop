  ...
  const _slideUp = (target, duration = 500) => {
    if (!target.classList.contains('_slide')) {
      ...
      window.setTimeout(() => {
        ...
        target.style.removeProperty('transtion-duration');
        target.style.removeProperty('transtion-property');
...
Для заголовков пойлеров пишем атрибут data-spoiler
...
Если нужно, чтобы в блоке был открыт только один спойлер (функцинал аккордеона),
то добавляем атрибут data-one-spoiler
*/